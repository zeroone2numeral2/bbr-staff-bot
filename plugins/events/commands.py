...
HANDLERS = (
    ...
    (PrefixHandler(COMMAND_PREFIXES, ["comment", "commento", "commenta", "cmt", "replyto", "rt", "rispondi"], on_comment_command, filters=ChatFilter.STAFF & filters.REPLY), Group.NORMAL),
